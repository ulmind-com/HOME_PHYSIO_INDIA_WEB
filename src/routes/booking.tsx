...
import { z } from "zod";
import { Phone, MessageCircle, Clock3, ShieldCheck, BadgeCheck, HeartHandshake, CheckCircle2 } from "lucide-react";
        ...
        <div className="container-x pt-32 pb-12 lg:pt-36 lg:pb-16 grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="space-y-6 lg:col-span-7 xl:col-span-7 z-10 relative">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-[64px] font-bold leading-[1.1] tracking-tight text-foreground">
              Book care in <span className="text-primary relative whitespace-nowrap">minutes.
            ...
            <p className="text-[17px] text-muted-foreground max-w-lg leading-relaxed font-medium">
              Tell us who and when — a care advisor will confirm the details shortly, usually within two hours.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5 sm:gap-8 pt-6">
              <div className="flex items-center gap-3.5">
                ...
                <div className="font-bold text-[15px] text-foreground leading-snug">Confirmation<br/><span className="text-muted-foreground font-medium text-[13px]">within 2 hours</span></div>
              </div>
              <div className="flex items-center gap-3.5">
                <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center shrink-0 shadow-sm">
                  <HeartHandshake className="w-5 h-5" />
                </div>
                <div className="font-bold text-[15px] text-foreground leading-snug">24/7 care desk<br/><span className="text-muted-foreground font-medium text-[13px]">always available</span></div>
              </div>
            </div>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-12 relative z-10">
          ...
          <div className="lg:col-span-7">
            <div className="rounded-[32px] border border-white/60 bg-white/70 backdrop-blur-3xl p-8 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.06)] lg:p-12 relative overflow-hidden">
              ...
              <h2 className="font-display text-[28px] font-bold tracking-tight md:text-[34px] mb-2 leading-tight">Tell us about the care you need</h2>
          ...
          <div className="lg:col-span-5 h-full">
            <div className="sticky top-28 rounded-[32px] border border-primary/10 bg-gradient-to-b from-primary/[0.03] to-primary/[0.08] backdrop-blur-2xl p-8 lg:p-12 relative overflow-hidden shadow-lg shadow-primary/5">
              ...
              <h3 className="text-[13px] font-bold uppercase tracking-widest text-primary mb-10">What happens next</h3>
              ...
              <div className="mt-12 pt-8 border-t border-black/5 space-y-4">
                {TRUST.map((t, i) => (
                  <div key={i} className="flex items-center gap-3 text-[14px] font-medium text-foreground">
              ...
              {(phone || whatsapp) && (
                <>
                  ...
                  <div className="text-[14px] font-semibold text-muted-foreground mb-4">Prefer to talk to someone now?</div>
