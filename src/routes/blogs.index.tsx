...
export const DUMMY_BLOGS: Blog[] = [
  {
    ...
    excerpt: "Caring for a loved one is one of the most emotional duties in any family. Learn when it's time to seek professional help to ensure they receive the best possible care without burning out.",
  ...
  },
  {
    ...
    excerpt: "Recovering after surgery is not always easy. Even after a successful operation, home ICU setups can provide better comfort, constant monitoring, and reduce the risk of hospital-acquired infections.",
  ...
  },
  {
    ...
    excerpt: "Simple habits to improve your physical and mental energy through natural wellness practices at home. Discover why moving away from traditional nursing homes is the new standard.",
  ...
  },
  {
    ...
    excerpt: "Physiotherapy is crucial for recovery. Here are the key things you must verify before hiring a professional, from certifications to understanding their approach to personalized care.",
