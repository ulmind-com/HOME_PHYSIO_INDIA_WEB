...
function BlogDetailsPage() {
  ...
  if (isError && !dummyMatch) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8F9FA]">
        ...
        <Link to="/blogs" className="text-primary hover:underline flex items-center gap-2 font-semibold">
  ...
  const imageUrl = typeof blog.featured_image === 'string' 
    ? blog.featured_image 
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative w-full h-[50vh] md:h-[70vh] min-h-[400px]">
        ...
        <div className="absolute bottom-[-1px] left-0 w-full overflow-hidden leading-none text-white">
          <svg className="relative block w-full h-[60px] md:h-[120px]" viewBox="0 0 1440 100" preserveAspectRatio="none">
          ...
          <div className="mt-16 prose prose-lg prose-headings:font-display prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary/80 prose-img:rounded-3xl max-w-none text-muted-foreground">
            {blog.content ? (
              ...
              <>
                ...
                <p>
                  Recovering from a major health event or managing a chronic condition is challenging for both the patient and their family. While hospitals provide critical care during emergencies, the home environment often offers unmatched comfort, familiarity, and emotional support during the recovery phase.
                </p>
                
                <h3 className="text-2xl text-foreground mt-10 mb-4">Benefits of Choosing Home Care</h3>
                <p>
                  Choosing home care is not just about convenience; it's about holistic healing. Being surrounded by loved ones, sleeping in a familiar bed, and eating home-cooked meals can significantly accelerate recovery. 
                </p>
                <div className="bg-primary/5 rounded-3xl p-8 my-8 border border-primary/10">
                  <ul className="space-y-4 list-none pl-0 m-0">
                    {[
                      ...
                      <li key={i} className="flex items-center gap-3 text-foreground font-medium m-0">
                ...
                <p>
                  Post-surgery recovery or elderly care becomes much easier when patients feel comfortable, emotionally supported, and properly cared for. Home care services help families create a safer and calmer recovery environment without losing access to professional medical care.
                </p>

                {/* Dummy FAQ Section */}
                <div className="mt-16 pt-12 border-t border-black/5">
                  <h2 className="text-3xl text-foreground font-display font-bold mb-8">Frequently Asked Questions</h2>
                  <div className="space-y-8">
                    <div>
                      <h4 className="text-lg font-bold text-foreground mb-2">1. What is home health care?</h4>
                      <p className="text-[15px] m-0">It provides hospital-like critical care support at home with trained nurses, equipment, monitoring, and medical supervision.</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-foreground mb-2">2. Who needs it after surgery?</h4>
                      <p className="text-[15px] m-0">Patients recovering from major surgery, elderly patients, or those needing close monitoring may need home ICU support.</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-foreground mb-2">3. Is it safe for post-surgery recovery?</h4>
                      <p className="text-[15px] m-0">Yes, when managed by trained professionals, home care can support safe recovery with regular monitoring and assistance.</p>
                    </div>
                  </div>
                </div>
              </>
