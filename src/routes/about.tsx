          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-8 py-4 text-base font-bold text-white shadow-lg shadow-[#25D366]/20 hover:brightness-110 hover:-translate-y-0.5 transition-all duration-300"
              >
