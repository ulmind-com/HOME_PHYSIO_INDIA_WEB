  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-w-[480px] w-full p-0 overflow-hidden rounded-[1.75rem] border border-white/15 bg-transparent shadow-[0_50px_100px_-30px_rgba(0,0,0,0.5)] sm:h-auto h-[100dvh] flex flex-col justify-center gap-0">
        ...
        {/* Glass background */}
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#20150c] via-[#2a1a0f] to-[#18100a] backdrop-blur-3xl" />

        {/* Decorative gradient orbs */}
        <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-amber-500/15 blur-[80px] pointer-events-none" />
        <div className="absolute -bottom-16 -left-16 h-36 w-36 rounded-full bg-orange-600/10 blur-[60px] pointer-events-none" />
          ...
          <AnimatePresence mode="wait">
            {done ? (
              ...
              >
                ...
                >
                  <div className="h-20 w-20 mx-auto rounded-full bg-gradient-to-br from-amber-400 to-orange-400 grid place-items-center shadow-[0_0_40px_-5px_rgba(251,191,36,0.4)]">
                ...
                {refCode && (
                  ...
                  >
                    ...
                    <span className="text-xs font-mono font-medium text-amber-300 tracking-wider">
                      {refCode}
                    </span>
                  </motion.div>
                )}
              ...
              >
                ...
                <motion.div
                  ...
                  className="mb-6"
                >
                  <div className="inline-flex items-center gap-2 rounded-full bg-amber-400/10 border border-amber-400/20 px-3 py-1 mb-4">
                ...
                <form onSubmit={form.handleSubmit((v) => mut.mutate(v))} className="space-y-3.5">
                  ...
                  <motion.div variants={fieldAnim} initial="hidden" animate="show" custom={1}>
                    <div className="relative group">
                      <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-amber-400 transition-colors">
                        <User className="h-4 w-4" />
                      </div>
                      <input
                        {...form.register("customer_name")}
                        placeholder="Full name"
                        className="w-full rounded-xl border border-white/10 bg-white/[0.06] pl-10 pr-4 py-3.5 text-sm text-white placeholder-white/35 outline-none transition-all duration-300 focus:border-amber-400/50 focus:bg-white/[0.08] focus:shadow-[0_0_0_3px_rgba(251,191,36,0.08)]"
                      />
                    </div>
                  ...
                  <motion.div variants={fieldAnim} initial="hidden" animate="show" custom={3}>
                    <div className="relative group">
                      <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-amber-400 transition-colors pointer-events-none">
                        <PackageSearch className="h-4 w-4" />
                      </div>
                      <select
                        {...form.register("equipment_name")}
                        className="w-full rounded-xl border border-white/10 bg-white/[0.06] pl-10 pr-4 py-3.5 text-sm text-white/60 focus:text-white outline-none transition-all duration-300 focus:border-amber-400/50 focus:bg-white/[0.08] focus:shadow-[0_0_0_3px_rgba(251,191,36,0.08)] appearance-none cursor-pointer"
                        style={{
                      ...
                      >
                        <option value="" className="bg-[#2a1a0f] text-white/50">
                          Select equipment
                        </option>
                        {EQUIPMENT_OPTIONS.map((e) => (
                          <option key={e} value={e} className="bg-[#2a1a0f] text-white">
                            {e}
                          </option>
                        ))}
                      </select>
                    ...
                    <motion.div variants={fieldAnim} initial="hidden" animate="show" custom={4}>
                      <div className="relative group">
                        ...
                        >
                          ...
                          {CITIES.map((c) => (
                            <option key={c} value={c} className="bg-[#2a1a0f] text-white">
                              {c}
                            </option>
                          ))}
                        </select>
                  ...
                  <motion.div variants={fieldAnim} initial="hidden" animate="show" custom={5}>
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-white/[0.06] px-4 py-3.5 text-sm text-white placeholder-white/35 outline-none transition-all duration-300 focus:border-amber-400/50 focus:bg-white/[0.08] focus:shadow-[0_0_0_3px_rgba(251,191,36,0.08)]"
                    />
                  </motion.div>
